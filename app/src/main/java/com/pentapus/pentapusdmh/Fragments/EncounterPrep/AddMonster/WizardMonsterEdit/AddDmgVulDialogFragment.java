 ...
 */
public class AddDmgVulDialogFragment extends DialogFragment {

    Button positiveButton;
    String dmgVul;


    public AddDmgVulDialogFragment(){
    }

    //mode: 0 = add, 1 = update
    public static AddDmgVulDialogFragment newInstance(String dmgVul) {
        AddDmgVulDialogFragment f = new AddDmgVulDialogFragment();

        // Supply num input as an argument.
        Bundle args = new Bundle();
        args.putString("dmgVul", dmgVul);
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        if(getArguments() != null){
            dmgVul = getArguments().getString("dmgVul");
        }
        setCancelable(true);
    }
    ...
    public Dialog buildDialog(){
        ...
        if(dmgVul != null){
            new Handler().post(new Runnable() {
                @Override
                public void run() {
                    ArrayList<String> selectedItems = splitString(dmgVul);
        ...
        builder.setPositiveButton("Done", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
               Bundle results = new Bundle();
                ...
                results.putStringArrayList("dmgVul", selections);
                sendResult(results);
            }
        });
